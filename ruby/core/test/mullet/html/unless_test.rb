...
module Mullet; module HTML
  ...
  class UnlessTest < MiniTest::Unit::TestCase
    ...
    def test_missing_value_should_render_element()
      template = @loader.load('unless.html')
      template.execute(@data, @output)

      assert_equal FALSE_OUTPUT, body() 
    end

    def test_nil_value_should_render_element()
    ...
    def test_false_should_render_element()
    ...
    def test_empty_array_should_render_element()
    ...
    def test_true_should_not_render_element()
    ...
    def test_non_empty_array_should_not_render_element()
    ...
    def test_object_should_not_render_element()
